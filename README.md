# 한이음 눈송이 꿈 (Hanium Snowflake Dream) 🌨️✨

시각장애인을 위한 AI 기반 접근성 학습 프로젝트

## 🎯 프로젝트 개요

한이음 눈송이 꿈은 시각장애인의 학습과 일상생활을 지원하는 AI 기반 접근성 솔루션입니다. 아두이노 조이스틱과 태블릿 펜을 활용하여 직관적인 인터렙션을 제공하며, OCR 기술을 통한 문자 인식 학습을 지원합니다.
...
이 프로젝트는 교육 목적으로 개발되었으며, 해당 기관의 정책을 따릅니다.
